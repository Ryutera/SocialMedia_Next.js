...
const page = ()=>{
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/auth/register", {
                data: {
                    name,
                    email,
                    password
...
_s(page, "sZqhRBCs1VxphM9j/6V0otZ4Pf4=", false, function() {
    return [
...
//# sourceMappingURL=_c598a19c._.js.map