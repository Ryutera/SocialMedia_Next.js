...
const login = ()=>{
    ...
    const { login } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$context$2f$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            //トークンを受けとる
            const responce = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/auth/login", {
                email,
                password
            });
...
_s(login, "so5uT0oWCrbZK9WIIyz5xDtJQGw=", false, function() {
    return [
...
//# sourceMappingURL=app_0a550639._.js.map