...
const Navbar = ()=>{
    _s();
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$context$2f$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    console.log(user);
...
_s(Navbar, "7L471R5W2aZaZepAzUZB25Tbetc=", false, function() {
    return [
