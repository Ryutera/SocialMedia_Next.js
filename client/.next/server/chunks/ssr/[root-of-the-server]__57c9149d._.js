...
const Timeline = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const newPost = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$apiClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/posts/post", {
                content: postText
            });
            setLatestPost((prev)=>[
                    newPost.data,
